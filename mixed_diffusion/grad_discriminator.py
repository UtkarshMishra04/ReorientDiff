...
class GradDiscriminator():
    ...
    def __init__(self, score_models, conditions, batch_size):
        self.score_models = score_models
        self.conditions = conditions
        self.batch_size = batch_size

    def calc_grad(self, candidate_samples):
        ...
        loss = 0
        for score_model, condition in zip(self.score_models, self.conditions):
    ...
    def last_step_discrimination(self, candidate_samples, num_grad_steps=10):
