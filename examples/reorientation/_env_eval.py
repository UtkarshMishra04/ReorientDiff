    ...
    def reset(self, pile_file=None):
        ...
        if self._real:
            ...
            if self._config is not None:
                pile_file = self._config["env_obs"]["pile_file"]
                place_pose = self._config["env_obs"]["place_pose"]
                target_fg_object_id = self._config["env_obs"]["target_instance_id"]
            ...
            self.fg_object_id = target_fg_object_id # self.random_state.choice(fg_object_ids)
