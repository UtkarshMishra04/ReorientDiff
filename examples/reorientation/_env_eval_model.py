    ...
    def reset(self, pile_file=None):
        ...
        if self._real:
            ...
            if self._config is not None:
                pile_file = self._config["pile_file"]
                place_pose = self._config["place_pose"]
                target_class_id = self._config["target_class_id"]
            ...
            for i in range(num_instances):
                ...
                if target_class_id is not None:
                    if class_id == target_class_id and visibility > 0.95:
            ...
            self.fg_object_id = fg_object_ids[0]
            ...
            self._shelf, self.PLACE_POSE = _utils.init_place_scene_eval(
                env=self,
