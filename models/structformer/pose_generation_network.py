...
from models.structformer.utils.rotation_continuity import compute_rotation_matrix_from_ortho6d
...
class PriorContinuousOutEncoderDecoderStructPCT6DDropoutAllObjects(torch.nn.Module):
    ...
    def __init__(self, vocab_size,
                 ...
                 encoder_num_layers=8, structure_dropout=0.0, object_dropout=0.0, theta_loss_divide=None):
        super(PriorContinuousOutEncoderDecoderStructPCT6DDropoutAllObjects, self).__init__()

        print("Transformer Encoder Decoder Struct with All Objects")
